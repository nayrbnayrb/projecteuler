...
print str(a00) + " " + str(a11) + " " + str(a22) + " " +str(a1919)
...
while j <=top:
	...
	while i+3 <= top:
		...
		if product > maximum:
			maximum = product
#		print str(j) + " " + str(i) + " " + str(product)
		i += 1
	j +=1

print "Maximum Left/Right = " + str(maximum)
# Up/Down
i = 0
j = 0
while j+3 <=top:
...
print "Maximum Up/Down = " + str(maximum)
...
print "Maximum UL/DR = " + str(maximum)
...
while j+3 <=top:
	i = 0
	while i+3 <= top:
		product = a[j][i+3] * a[j+1][i+2] * a[j+2][i+1] * a[j+3][i]
		if product > maximum:
			maximum = product
		print str(j) + " " + str(i) + " " + str(product)
		i += 1
...
print "Maximum DLeft/URight = " + str(maximum)
